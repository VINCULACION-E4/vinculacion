...
<div class="bg-white py-6 sm:py-8 lg:py-12">
        ...
        <div class="flex w-full items-center p-4 sm:w-2/3 sm:p-8 lg:w-1/2 lg:pl-10">
          <div class="flex w-full flex-col items-center sm:block">
            <div class="mb-4 sm:mb-8">
              <h2 class="text-center text-xl font-bold text-green-500 sm:text-left sm:text-2xl lg:text-3xl">{{ $oferta->nombre}}</h2>
              ...
              <p class="text-center font-bold text-gray-500 sm:text-left"> Área: {{ $oferta->area_residencia}}</p><br>
  ...
  <div class="text-center text-xl font-bold text-green-500 sm:text-left sm:text-2xl lg:text-3xl">
