...
<div class="container mx-auto px-4">
  ...
  <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
    ...
    <form action="/empleador/focus-group/enviar-mensaje" method="POST">
      @csrf
      ...
      <input type="hidden" name="tipo_usuario" value="Empleador">
      <input type="hidden" name="focus_group_id_focus_group" value="{{ $focusGroup->id_focus_group }}">
      <input type="hidden" name="nombre_usuario" value="{{ $usuario->empleadore->nombre_comercial }} ">
