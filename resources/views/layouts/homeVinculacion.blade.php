...
@section('content')
    <section class="max-w-4xl mx-auto p-8 mt-8 bg-green-50 border-l-8 border-green-400 text-green-800 rounded-xl shadow-xl">
        <div class="flex items-center space-x-3">
            ...
            <p class="text-2xl font-semibold text-green-700">¡Registro completado con éxito!</p>
        </div>
       
        <div class="mt-6 flex justify-center">
            <a href="/mostrarAlumnos" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-full text-lg font-semibold shadow-md hover:bg-blue-700 hover:shadow-lg transition duration-300 ease-in-out">
                Continuar
            </a>
        </div>
    </section>
